...
const BookshtmlForm = ({ btonName, setStateModal }) => {
  ...
  const [book, setBook] = useState({
    ...
    yearOfPublication: "",
    srcImage:
      "https://us.123rf.com/450wm/nikiteev/nikiteev1712/nikiteev171200048/91247923-vector-de-dibujos-animados-amarillo-doodle-signo-de-interrogaci%C3%B3n-sobre-fondo-blanco-aislado.jpg?ver=6",
    description: "",
    isbn: "",
  });
  ...
  const handleSubmit = (e) => {
    ...
    if (params.id) {
      ...
      dispatch(
        //el spread operator permite anexarle el id dentro del mismo arreglo, si le saco los ... me devuelve un objeto con los datos por un lado y el id por el otro.
        addBook({
          ...book,
          id: uuidv4(),
        })
